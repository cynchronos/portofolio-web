...
const Sidebar = () => {
  return (
    <aside className="flex bg-[#272727] flex-auto w-full lg:w-3/12 lg:rounded-2xl justify-center bg-opacity-85 overflow-auto scrollbar-none">
      <span className="flex flex-col w-3/4 h-full items-center">
        ...
        <div className="grid grid-cols-2 lg:contents gap-x-4">
          {
