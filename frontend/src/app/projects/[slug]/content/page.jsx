...
const Page = ({ params }) => {
  ...
  const { projects: initProject, error: errorProject, isLoaded: projectLoaded } = useFetchProjects(params)

  const fetchData = async () => {
    try {
      if (initProject && projectLoaded && !errorProject) {
  ...
  }, [projectLoaded, project, error])

  const allLoaded = projectLoaded && isLoaded

  return (
    <>
      <DashboardLayout title="Projects">
        <div className="relative">
          <div className="absolute invisible md:visible  pl-6 md:pl-12 pt-5">
            <Link href="/projects">
        ...
        </div>
        {
          allLoaded && !error ? (
            <div className="flex flex-col px-6 md:px-12 pb-10">
              ...
              <div className="mb-10 mt-20 mx-5 md:mx-16 lg:mx-32">
                <Image
